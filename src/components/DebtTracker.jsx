...
const DebtTracker =()=>{
    ...
    const [debtInput, setDebtInput] = useState(
        ...
        const handleInput=(event)=>{
            ...
            setDebtInput({...debts, [name]:value});
        };

        const addDebt = ()=>{
            setDebts([...debts, {...debtInput, amount: parseFloat(debtInput)}]);
            setDebtInput({creditor:"", amount:"", dueDate: "", status:"upaid"});
        };
          ...
          return (
            <div>
               ...
               <div>
                ...
                <input type="number" name="dueDate" value={debtInput.dueDate} onChange={handleInput}/>
